...
public class BlockCoffeeGrinder extends BlockContainer {
	@SideOnly(Side.CLIENT)
	private IIcon[] iconArray;
	
	public BlockCoffeeGrinder(){
		super(Material.rock);
		setHardness(3.0F);
		setCreativeTab(CoffeecraftMain.creativeTab);
		setBlockName("coffeeGrinder");
    ...
    public void registerBlockIcons(IIconRegister register){
		...
		iconArray[0] = register.registerIcon(CoffeecraftMain.MODID+":coffeeGrinder");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9){
		player.openGui(CoffeecraftMain.instance, Gui.COFFEE_GRINDER_ID, world, x, y, z);
		return true;
	}
}
