...
public class GuiExtractingMachine extends GuiContainer {
	private TileEntityExtractingMachine tile;
	public GuiExtractingMachine(InventoryPlayer inventory, TileEntityExtractingMachine tileEntityCoffeeGrinder){
		super(new ContainerExtractingMachine(inventory, tileEntityCoffeeGrinder));
	...
	protected void drawGuiContainerForegroundLayer(int arg0, int arg1) {
		 ...
		 fontRendererObj.drawString(StatCollector.translateToLocal("container.extractingMachine"), 65, 6, 4210752);
	...
	protected void drawGuiContainerBackgroundLayer(float arg0, int arg1, int arg2) {
		...
		this.mc.renderEngine.bindTexture(new ResourceLocation(CoffeecraftMain.MODID,"textures/gui/ExtractingMachine.png"));
        ...
        float totalTime = 800.0F;
        if(b > 0){
            this.drawTexturedModalRect(this.guiLeft + 83, this.guiTop + 35, 176, 17, (int)(24 * ((float)b / totalTime)), 17);
        }
	}
}
