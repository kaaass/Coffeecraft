...
public class GuiCoffeeGrinder extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float arg0, int arg1, int arg2) {
        ...
        //draw anvil
        if(tile.getWorldObj().getBlock(tile.xCoord, tile.yCoord + 1, tile.zCoord) == Blocks.anvil){
        	this.drawTexturedModalRect(this.guiLeft + 132, this.guiTop + 62, 176, 33, 16, 16);
        }
        //draw progress bar
