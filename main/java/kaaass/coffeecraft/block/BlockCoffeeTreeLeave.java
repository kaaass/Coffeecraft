...
public class BlockCoffeeTreeLeave extends BlockLeavesBase implements IShearable {
	int[] adjacentTreeBlocks;
	IIcon icon;
	
	public BlockCoffeeTreeLeave(){
	    ...
	    setBlockTextureName(CoffeecraftMain.MODID+":coffeeTreeLeaveBlock");
	}
	...
	public Item getItemDropped(int meta, Random rand, int par3){
	    return Items.coffeeTreeSapling;
	}
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune){
		...
		if (world.rand.nextInt(18) == 0) {
			ret.add(new ItemStack(Items.coffeeTreeSapling, 1, 0));
		}
	    return ret;
	}
	...
	public ArrayList<ItemStack> onSheared(ItemStack arg0, IBlockAccess arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		ret.add(new ItemStack(Block.getBlockById(18), 1, 1));
		return ret;
	}
